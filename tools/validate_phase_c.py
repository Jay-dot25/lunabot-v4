...
check("Phase C runtime evidence is labelled accurately",
      launch.count('--phase-label "Phase C"') == 2 and
      '--phase-label' in read("scripts/wasd_teleop.py") and
      '--phase-label' in read("scripts/odometry_monitor.py"))
